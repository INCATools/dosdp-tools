 ...
 */
object CompiledPatternCorrectnessTest extends ZIOSpecDefault {

  private val emptyOWLSource = AxiomRestrictionsTest.OboInOwlSource

  val spec = suite("CompiledPattern correctness") (
    test("empty equivalentTo (no text, no multi_clause) emits no logical axiom") {
    ...
    test("empty subClassOf emits no logical axiom") {
      val pattern = DOSDP.empty.copy(
    ...
    test("empty disjointWith emits no logical axiom") {
      val pattern = DOSDP.empty.copy(
    ...
    test("empty non-GCI logical_axioms entry is skipped") {
      val pattern = DOSDP.empty.copy(
    ...
    test("equivalentTo with empty multi_clause clauses list emits no axiom") {
      val pattern = DOSDP.empty.copy(
    ...
    test("equivalentTo with multi_clause clauses=None emits no axiom") {
      val pattern = DOSDP.empty.copy(
    ...
    test("annotations-only equivalentTo (no text, no multi_clause) emits no logical axiom") {
      val pattern = DOSDP.empty.copy(
    ...
    test("empty SubClassOf logical_axioms entry is skipped") {
      val pattern = DOSDP.empty.copy(
    ...
    test("empty DisjointWith logical_axioms entry is skipped") {
      val pattern = DOSDP.empty.copy(
    ...
    test("empty top-level GCI body emits no axiom") {
      val pattern = DOSDP.empty.copy(
    ...
    test("empty GCI logical_axioms entry is skipped") {
      val pattern = DOSDP.empty.copy(
    ...
    test("annotations-only top-level GCI emits no axiom") {
      val pattern = DOSDP.empty.copy(
